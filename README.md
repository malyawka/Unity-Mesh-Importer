...
* Mesh - allows you to transfer data from an external mesh to this mesh. For example, you can replace the Tangent array of this mesh with the Normal array of another mesh. '/n'<img src="/../pics/pics/Mesh.png" width="50%" height="50%">
